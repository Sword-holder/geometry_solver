...
def create_problem():
    ...
    angle_bac = Angle('BAC', sides=[line_ab, line_ac], angle=45)
    ...
    angle_bfd = Angle('BFD', sides=[line_df, line_bf], angle=None)
    angle_dfe = Angle('DFE', sides=[line_df, line_ef], angle=None)
    angle_cfe = Angle('CFE', sides=[line_cf, line_ef], angle=None)
    angle_bfc = Angle('BFC', sides=[line_bf, line_cf], angle=None)
