...
def create_problem():
    ...
    angle_bac = Angle('BAC', sides=[line_ab, line_ac], angle=60)
    angle_bad = Angle('BAD', sides=[line_ab, line_ad], angle=90)
    angle_cad = Angle('CAD', sides=[line_ac, line_ad], angle=None)
    angle_abc = Angle('ABC', sides=[line_ab, line_bc], angle=90)
    angle_abd = Angle('ABD', sides=[line_ab, line_bd], angle=45)
    angle_cbd = Angle('CBD', sides=[line_bc, line_bd], angle=None)
    angle_acb = Angle('ACB', sides=[line_ac, line_ab], angle=30)
    angle_adb = Angle('ADB', sides=[line_ad, line_bd], angle=45)
    angle_aeb = Angle('AEB', sides=[line_ae, line_be], angle=None)
    angle_aed = Angle('AED', sides=[line_ae, line_de], angle=None)
    angle_bec = Angle('BEC', sides=[line_be, line_ce], angle=None)
    angle_ced = Angle('CED', sides=[line_ce, line_de], angle=None)
