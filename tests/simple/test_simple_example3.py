...
def create_problem():
    ...
    angle_bae = Angle('BAE', sides=[line_ab, line_ae], angle=None)
    angle_bad = Angle('BAD', sides=[line_ab, line_ad], angle=None)
    angle_bac = Angle('BAC', sides=[line_ab, line_ac], angle=None)
    angle_dae = Angle('DAE', sides=[line_ad, line_ae], angle=None)
    angle_cae = Angle('CAE', sides=[line_ac, line_ae], angle=None)
    angle_cad = Angle('CDD', sides=[line_ad, line_cd], angle=None)
    angle_abc = Angle('ABC', sides=[line_ab, line_bc], angle=36)
    angle_acb = Angle('ACB', sides=[line_ac, line_bc], angle=76)
    angle_adc = Angle('ADC', sides=[line_ad, line_cd], angle=None)
    angle_adb = Angle('ADB', sides=[line_ad, line_bd], angle=None)
    angle_aeb = Angle('AEB', sides=[line_ae, line_be], angle=None)
    angle_aec = Angle('AEC', sides=[line_ae, line_ce], angle=None)
    ...
    triangle_abe = Triangle('ABE', vertexes=[p_a, p_b, p_e], sides=[line_ab, line_ae, line_be], angles=[angle_aeb, angle_abc, angle_bae], area=None)
    ...
    triangle_ace = Triangle('ACE', vertexes=[p_a, p_c, p_e], sides=[line_ac, line_ae, line_ce], angles=[angle_aec, angle_acb, angle_cae], area=None)
    triangle_ade = Triangle('ADE', vertexes=[p_a, p_d, p_e], sides=[line_ad, line_ae, line_de], angles=[angle_aec, angle_adb, angle_dae], area=None)
...
def create_target(problem):
    target = Target(TargetType.EVALUATION,
                    entity=problem.entity.find_child('DAE', type_=Angle),
                    attr='angle')
    return target
