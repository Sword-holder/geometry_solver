...
def create_problem():
    ...
    angle_bae = Angle('BAE', sides=[line_ab, line_ae], vertex=p_a, angle=None)
    ...
    angle_dae = Angle('DAE', sides=[line_ad, line_ae], vertex=p_a, angle=None)
    angle_cae = Angle('CAE', sides=[line_ac, line_ae], vertex=p_a, angle=None)
    ...
    angle_aec = Angle('AEC', sides=[line_ae, line_ce], vertex=p_e, angle=None)
